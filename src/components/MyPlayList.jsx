...
const MyPlaylist = () => {
  ...
  const [newPlayListCreate,setNewPlaylistCreate]=useState(1)
  ...
  const handleCreatePlaylist=(value)=>{

    setNewPlaylistCreate((prev)=>prev+1)
  }
  ...
  >
    ...
    {createIsOpen && <>  <PlaylistCreator setCreateIsOpen={setCreateIsOpen} setNewPlaylistCreate={setNewPlaylistCreate}  handleCreatePlaylist={handleCreatePlaylist}/> </>}
