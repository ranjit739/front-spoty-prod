...
const PlaylistCreator = ({ setCreateIsOpen,handleCreatePlaylist }) => {
    ...
    return (
        <div className="max-w-lg mx-auto mt-5 mb-10 bg-gray-800 p-6 rounded-lg shadow-lg">
